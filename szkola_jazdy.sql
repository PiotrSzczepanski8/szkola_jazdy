...
--
-- Host: 127.0.0.1
-- Czas generowania: 03 Mar 2025, 18:44
...
INSERT INTO `kurs` (`id_kurs`, `kategoria`, `opis`, `cena`, `h_praktyka`, `h_teoria`, `obrazek`) VALUES
(1, 'A', 'Dzięki temu rodzajowi prawa jazdy będziesz mógł poruszać się każdym jednośladem bez względu na pojemność czy moc silnika.', '2999.99', 20, 30, 'car.webp'),
(2, 'B', 'Prawo jazdy kategorii B pozwoli Ci prowadzić samochody osobowe, minibusy i kempingi.', '2499.99', 30, 30, 'car.webp'),
(3, 'C', 'Kategoria C jest dla Ciebie jeśli chcesz prowadzić samochody ciężarowe', '5499.99', 25, 20, 'car.webp'),
(4, 'D', 'Dzieki kategorii D będziesz mógł prowadzić autobusy.', '7499.99', 60, 20, 'car.webp'),
(5, 'B+E', 'B+E to rozszerzenie kategorii B, które pozwala na prowadzenie pojazdów o większej ładowności.', '1999.99', 15, 0, 'car.webp'),
(6, 'C+E', 'Kategoria C+E to rozszerzenie kategorii C, które pozwala Ci prowadzić zespół pojazdów bez żadnych limitów wagowych.', '6499.99', 25, 0, 'car.webp'),
(7, 'D+E', 'Dzięki temu rozszerzeniu kategorii D, możesz prowadzić autobusy z przyczepą bez ograniczeń tonażowych.', '8999.99', 30, 0, 'car.webp'),
(8, 'A1', 'Dzięki temu rodzajowi prawa jazdy będziesz mógł prowadzić jednoślad, jednak o mniejszej mocy i pojemności silnika niż w kategorii A.', '2499.99', 15, 30, 'car.webp'),
(9, 'B1', 'Kategoria B1 uprawnia Cię do kierowania małym samochodem osobowym rozpędzającym się do 100km/h.', '1999.99', 20, 30, 'car.webp'),
(10, 'C1', 'Prawo jazdy kategorii C1 uprawnia Cię do kierowania pojazdami ciężarowymi, których waga nie przekracza 7,5 tony.', '3999.99', 20, 20, 'car.webp'),
(11, 'D1', 'Prawo jazdy ketegorii D1 pozwala Ci prowadzić autobusy o długości do 8 metrów', '5999.99', 40, 20, 'car.webp'),
(12, 'C1+E', 'Kategoria C1+E uprawnia Cię do kierowania mniejszymi ciężarówkami z przyczepą.', '4499.99', 20, 0, 'car.webp'),
(13, 'D1+E', 'Kategoria D1+E uprawnia Cię do kierowania zespołem pojazdów (pojazd ciągnący i przyczepa) o wadze nie przekraczającej 12t.', '5999.99', 25, 0, 'car.webp'),
(14, 'T', 'Kategoria T uprawnia Cię do kierowania traktorem.', '2999.99', 20, 20, 'car.webp');
...
INSERT INTO `pracownik` (`id_pracownik`, `imie`, `nazwisko`, `telefon`, `email`, `miasto`, `ulica`, `nr_lokalu`, `login`, `haslo`, `typ_pracownika`, `opis`) VALUES
(1, 'Karol', 'Robak', '+48 667 887 123', 'karolrobak112@rak.pl', 'Kraków', 'Wodna', '7', 'admin', 'trudneHaslo123#', 'admin', NULL),
(2, 'Marta', 'Koralowa', '+48 567 874 123', 'martakoralowa@koral.pl', 'Poznań', 'Rolnicza', '9', 'in_marta.k', 'kochamPieskiUwU', 'instruktor', NULL),
(3, 'Kamil', 'Ślimak', '+48 934 567 999', 'kamil@slimak.palindrom.pl', 'Rybnik', 'Koziołkowska', '37', 'kamilślimak', 'jestemWolny!', 'instruktor', 'Poznaj Kamila - młodego instruktora z pasją do motoryzacji i nowoczesnym podejściem do nauki jazdy. Łączy spokojną atmosferę z praktycznymi wskazówkami, pomagając kursantom budować pewność siebie za kierownicą. Z nim teoria staje się prosta, a jazdy to przyjemność, nie stres.'),
(4, 'Barbara', 'Grom', '+48 567 321 123', 'basiagrom@gmail.com', 'Warszawa', 'Długa', '19/4', 'baśkaInstruktorka', 'Pimpuś2019!', 'instruktor', NULL),
(5, 'Krzysztof', 'Rączka', '+48 876 871 002', 'pan@krzysztof.pl', 'Mikołów', 'Robotnicza', '7/8', 'krzy88', 'krzysiuMisiu88', 'instruktor', NULL);
...
--
ALTER TABLE `transakcja`
  MODIFY `id_transakcja` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
